...
const rows = [
  { word: 'certain', partsOfSpeech: '형용사', meaning: '확실한, 틀림없는' },
  { word: 'deserve', partsOfSpeech: '동사', meaning: '…을 받을 만하다[누릴 자격이 있다], …을 (당)해야 마땅하다' },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.partsOfSpeech}</TableCell>
